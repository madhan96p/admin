document.addEventListener("DOMContentLoaded", function () {
  ...
  const DEFAULT_LOGO_URL =
    "https://admin.shrishgroup.com/assets/images/logo.webp";
  ...
  const stylePresets = {
    ...
    oceanic: {
      ...
      cornersColor1: "#0369a1",
      cornersColor2: "#0369a1",
      cornersGradientType: "none",
      bgColor: "#ffffff",
      frameToggle: true,
      frameText: "SCAN ME",
    ...
    "mono-dark": {
      ...
      cornersColor1: "#e5e7eb",
      cornersColor2: "#e5e7eb",
      cornersGradientType: "none",
      bgColor: "#1f2937",
      frameToggle: true,
      frameText: "SCAN HERE",
      frameColor: "#374151",
      frameTextColor: "#e5e7eb",
    },
    "soft-mint": {
      dotsType: "dots",
      dotsColor1: "#047857",
      dotsColor2: "#059669",
      dotsGradientType: "radial",
      cornersColor1: "#065f46",
      cornersColor2: "#065f46",
      cornersGradientType: "none",
      bgColor: "#ecfdf5",
      frameToggle: false,
      frameText: "SCAN ME",
  ...
  function updateFrame() {
    ...
    if (isEnabled) {
      ...
      container.style.setProperty(
        "--frame-bg-color",
        elements.frameColor.value,
      );
      container.style.setProperty(
        "--frame-text-color",
        elements.frameTextColor.value,
      );
  ...
  const updateQRCode = () => {
    ...
    // 1. Get Content Data
    const qrType = document.querySelector("[data-qr-type].active").dataset
      .qrType;
    ...
    const dotsOptions = getColorOptions(
      elements.dotsColor1.value,
      elements.dotsColor2.value,
      elements.dotsGradientType.value,
    );
    const cornersSquareOptions = getColorOptions(
      elements.cornersColor1.value,
      elements.cornersColor2.value,
      elements.cornersGradientType.value,
    );
    ...
    qrCode.update({
      ...
      cornersSquareOptions: {
        ...cornersSquareOptions,
        type: elements.cornerSquareType.value,
      },
      ...
      image: logoImage,
      imageOptions: {
        imageSize: parseFloat(elements.logoSizeSlider.value),
        margin: 5,
      },
    });
  };
  ...
  const inputsToWatch = [
    elements.upiIdInput,
    elements.payeeNameInput,
    elements.amountInput,
    elements.webLinkInput,
    elements.dotsType,
    elements.cornerSquareType,
    elements.cornerDotType,
    elements.bgColor,
    elements.dotsColor1,
    elements.dotsColor2,
    elements.dotsGradientType,
    elements.cornersColor1,
    elements.cornersColor2,
    elements.cornersGradientType,
    elements.logoSizeSlider,
    elements.errorCorrectionLevel,
  ];
  ...
  const frameInputs = [
    elements.frameToggle,
    elements.frameText,
    elements.frameColor,
    elements.frameTextColor,
  ];
  ...
  elements.downloadPngBtn.addEventListener("click", () =>
    qrCode.download({
      name: elements.filenameInput.value || "qr-code",
      extension: "png",
    }),
  );
