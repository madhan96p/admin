document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadRoutes() {
        ...
        try {
            ...
            console.error(err);
            tableBody.innerHTML = '<tr><td colspan="6" class="text-danger">Error loading routes</td></tr>';
        }
    }
    ...
    window.openEdit = (slug) => {
        ...
        document.getElementById('modal-title').innerText = "Edit Route: " + route.Destination;
