...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const categoryData = {
        Company: {
            Debit: {
                "Vehicle Expense": ["Fuel", "Fastag", "Permit/Tax", "Maintenance", "Vehicle EMI", "Insurance", "Parking"],
                "Operations": ["Driver Salary", "Driver Batta", "Staff Salary"],
                "Admin": ["Office Rent", "Phone/Internet", "Bank Charges", "Marketing", "Software", "Other"]
            },
            Credit: {
        ...
        Personal: {
            Debit: {
                "Family Expense": ["Groceries", "Food (Outside)", "Utilities (EB, Gas)", "Medical"],
                "Personal Expense": ["Rent", "EMI", "Credit Card Bill", "Shopping", "Entertainment", "Other"],
